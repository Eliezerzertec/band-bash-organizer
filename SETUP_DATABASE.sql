...
-- https://app.supabase.com → SQL Editor → Nova Query
...
CREATE INDEX idx_ministries_leader_id ON public.ministries(leader_id);
CREATE INDEX idx_teams_ministry_id ON public.teams(ministry_id);
...
CREATE INDEX idx_schedules_church_id ON public.schedules(church_id);
CREATE INDEX idx_schedules_ministry_id ON public.schedules(ministry_id);
CREATE INDEX idx_schedule_assignments_schedule_id ON public.schedule_assignments(schedule_id);
CREATE INDEX idx_schedule_assignments_profile_id ON public.schedule_assignments(profile_id);
CREATE INDEX idx_substitution_requests_requester_id ON public.substitution_requests(requester_id);
CREATE INDEX idx_substitution_requests_substitute_id ON public.substitution_requests(substitute_id);
...
-- =============================================
-- FUNÇÃO PARA AUTO-CRIAR PROFILE NO SIGNUP
-- =============================================
...
-- =============================================
-- POLÍTICAS RLS - SCHEDULE_ASSIGNMENTS
-- =============================================
...
-- =============================================
-- POLÍTICAS RLS - SUBSTITUTION_REQUESTS
-- =============================================
